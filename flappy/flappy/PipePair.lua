...
-- local GAP_HEIGHT = 90
-- randomized size of the gap between pipes
   local randGAP_HEIGHT = math.random(70, 90)
...
function PipePair:init(y)
    ...
    self.pipes = {
        ...
        ['lower'] = Pipe('bottom', self.y + PIPE_HEIGHT + randGAP_HEIGHT)
    }

    -- After the creation of a Pipe Par, randomize the gap height 
    randGAP_HEIGHT = math.random(70, 90)
